...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  mounted: function mounted() {
    ...
    window.Echo["private"]('chat').listen('NewMessage', function (data) {
  ...
  methods: {
    add: function add() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_0___default().post('/test-event', {
    ...
    [
      ...
      _c(
        ...
        [
          ...
          _vm._v(" "),
          _c("button", { on: { click: _vm.add } }, [_vm._v("Send")]),
          _vm._v("\n        " + _vm._s(_vm.content) + "\n    "),
        ]
      ),
      _vm._v(" "),
...
var staticRenderFns = [
  function () {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("audio", { attrs: { id: "noti" } }, [
      _c("source", {
        attrs: {
          src: "https://notificationsounds.com/storage/sounds/file-sounds-1233-elegant.mp3",
          type: "audio/mpeg",
        },
      }),
    ])
